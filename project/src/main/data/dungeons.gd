...
static func get_dungeon_select_info(dungeon: Dungeon) -> Dictionary[String, String]:
	var reward_text: String = "+💰%s" % [Utils.abbr_num(dungeon.recon_army.get_total_gold())]
	...
	var attack_string: String = "%s⚔" % [Utils.abbr_num(dungeon.recon_army.get_total_attack())]
