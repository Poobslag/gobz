...
sed -i "s|export_path=\"export/windows/.*\"|export_path=\"export/windows/gobz-win-v$version.zip\"|g" project/export_presets.cfg
sed -i "s|export_path=\"export/linux/.*\"|export_path=\"export/linux/gobz-linux-v$version.zip\"|g" project/export_presets.cfg
sed -i "s|export_path=\"export/android/.*\"|export_path=\"export/android/gobz-android-v$version.apk\"|g" project/export_presets.cfg
