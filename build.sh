...
sed -i "s|##WIN_EXE_FILENAME##|gobz-win-v$version.exe|g" "$win_bat_filename"
...
web_zip_filename="$web_export_path/gobz-web-v$version.zip"
web_src_html_filename="$web_export_path/gobz.html"
